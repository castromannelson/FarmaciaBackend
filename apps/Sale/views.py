...
class SalesFilterListView(APIView):
    def get(self,request):
        sales = Sale.objects.filter(saleDate__gte=(datetime.now()-timedelta(days=7)))
...
class ReporteSaleExel(APIView):
    def get(self,request,*args,**kwargs):
        ...
        nombre_archivo = f"Factura de Ventas de {fecha_hace_una_semana_str} a {fecha_actual_str}.xlsx"
